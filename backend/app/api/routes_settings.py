...
ALLOWED_FIELDS = {
    ...
    "graduate_model_name",
    "subagent_model_name",
    "independent_reviewer_model_name",
    "llm_timeout",
    "llm_max_retries",
    "llm_max_tokens",
...
async def get_settings():
    ...
    return {
        ...
        "independent_reviewer_model_name": settings.independent_reviewer_model_name or settings.graduate_model_name or settings.llm_model_name,
